...
public class ShopServiceDetailsController extends Controller {
    ...
    @Inject
    public ShopServiceDetailsController(AlertService alertService, ShopItemsService shopItemsService, ViewLoader viewLoader) {
    ...
    private void handleNewShopService() {
        ...
        if (okClicked) {
            Result addResult = shopItemsService.addShopService(shopService);
    ...
    private void handleEditShopService() {
        ...
        if (shopService != null) {
            boolean okClicked = showShopServiceEditDialog(shopService);
            if (okClicked) {
                Result editResult = shopItemsService.editShopService(shopService);
